...
def lowerletters_re(name=None):
    if name:
        return u'(?P<<{}>>'.format(name) + tokenized_re(u'[a-záéíóúñ]*') + u')'
    else:
        return tokenized_re(u'[a-záéíóúñ]*')

def capitalizedletters_re(name=None):
    if name:
        return u'(?P<<{}>>'.format(name) + tokenized_re(u'[A-ZÁÉÍÓÚÑ][a-záéíóúñ]*') + u')'
    else:
        return tokenized_re(u'[A-ZÁÉÍÓÚÑ][a-záéíóúñ]*')